    ...
    ${selectedUser ? "max-md:hidden" : ""}`}>
      <div className='pt-16 flex flex-col items-center gap-2 text-xs font-light mx-auto'>
        ...
        justify-center gap-2'>
            {onlineUsers.includes(selectedUser._id) && <p className='w-2 h-2 rounded-full 
            bg-green-500'></p>}
      ...
      bg-gradient-to-r from-purple-400 to-violet-600 text-white px-20 py-2 border-none
      text-sm font-light rounded-full cursor-pointer hover:opacity-90'>
        Logout
      </button>
